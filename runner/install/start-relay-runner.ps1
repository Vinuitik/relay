...
# auto-start (laptop)". Not a Windows service (self-update's binary-replace
# doesn't reliably work on Windows anyway - see FLOWS.md Technology Notes),
# just a background process relaunched at logon.
